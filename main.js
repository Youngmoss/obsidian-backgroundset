...
exports.MySettingTab = MySettingTab;
module.exports = class MyPlugin extends Plugin {
  ...
  deleteBackground() {
    ...
    if (styleElement && body.classList.contains('active')) {
      // 触发淡出效果
      this.fadeOutBackground(styleElement);
  ...
  fadeOutBackground(styleElement) {
    const body = document.body;
  ...
  setRandomBackground() {
    ...
    // 随机选择一个图片
    const randomIndex = Math.floor(Math.random() * this.settings.imageAdressList.length);
